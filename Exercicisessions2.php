...
<head>
    ...
    <title>Botiga exercici session</title>
...
<?php
    if (isset($_POST["usuario"]) and isset($_POST["contraseña"])){
        if(($_POST["usuario"]=="Victor") and ($_POST["contraseña"]=="vaiktor")) {
            ...
            header("Location:sesionfail.php");
        }
...
<form class="formright" action="exercicisessions2.php" method="post">
...
<form action="Exercici52b.php" method="get">
